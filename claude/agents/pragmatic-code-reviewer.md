...
description: |
  Thorough code reviewer balancing engineering excellence with development velocity.
  Invoke after completing a feature, implementing a logical chunk of code, or before merging a PR.
  Focuses on architecture, security, correctness, and maintainability with actionable feedback.
tools: Bash, Glob, Grep, Read, Edit, MultiEdit, Write, WebFetch, TodoWrite, mcp__Ref__ref_search_documentation, mcp__exa__web_search_exa
model: opus
color: red
---
